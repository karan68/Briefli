...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::api_commitments_sync,
            api::api_commitments_list,
            api::api_commitments_set_status,
            api::api_memories_sync,
            api::api_memories_list,
            api::api_memory_review,
            api::api_memory_set_resolution,
            api::api_memory_mark_follow_up_reviewed,
            api::api_memory_owner_aliases_list,
            api::api_memory_owner_alias_delete,
            api::api_memory_spaces_create,
            api::api_memory_spaces_list,
            api::api_memory_space_rename,
            api::api_memory_space_delete,
            api::api_memory_space_assignments,
            api::api_memory_space_assign,
            api::api_memory_space_brief,
            api::api_brief_metrics_get,
            api::api_brief_metrics_set_enabled,
            api::api_brief_metrics_record,
            api::api_brief_metrics_clear,
            api::api_get_profile,
        ...
        .run(|_app_handle, event| {
            match event {
                ...
                tauri::RunEvent::Exit => {
                    ...
                    tauri::async_runtime::block_on(async {
                        if let Some(runtime) =
                            _app_handle.try_state::<device_sync::commands::DeviceSyncRuntimeState>()
                        {
